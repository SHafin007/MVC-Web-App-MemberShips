...
namespace Memberdhips_1.Areas.Admin.Controllers
{
    ...
    public class ItemController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Title,Description,Url,ImageUrl,HTML,WaitDay,ProductId,PartId,SectionId,ItemTypeId,IsFree")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Title,Description,Url,ImageUrl,HTML,WaitDay,ProductId,PartId,SectionId,ItemTypeId,IsFree")] Item item)
        {
            if (ModelState.IsValid)
            {
